...
Das Lösen des Gleichungssystems \ref{eq:Minimierungsproblem} ist mathematisch gesehen die Kernaufgabe des Algorithmus. Das Gleichungssystem besitzt $m\cdot n$ Gleichungen und $L\cdot n$ Unbekannte. In der Regel ist dieses Gleichungssystem überbestimmt, da die Anzahl der Ansatzfunktionen überschaubar sein sollte, während die Zahl der Messungen deutlich größer sein sollte. Es existieren verschiedene Optimierungsverfahren, um dieses Problem der Form
\begin{equation}
Ax=b
\end{equation}
